...
class TicTacToe:
    def __init__(self):
        ...
        self.current_winner = None # kepp track of winner
    ...
    def winner(self, square, letter):
        # winner if 3in a row anywhere we have to check all of these
        ...
        # these are the only moves possible to win in diagonal
        if square % 2 == 0:
...
def play(game, x_player, o_player, print_game=True):
    ...
    while game.empty_squares():
        ...
        # lets define a fuction to make a move!
